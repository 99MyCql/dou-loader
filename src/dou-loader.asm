...
ProgCount	dw	7 ; 加载程序数量
prompt_msg	db	0DH, 0AH, "Choose:", 0DH, 0AH, "1.helloworld  2.sum&diff  3.clock  4.keyboard  5.div  6.extend-IO  7.dou-snake", 0DH, 0AH, "dou-loader > ", 0
